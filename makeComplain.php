        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
          ...
          <tr class="entryTable">
			...
			<select name="compType" class="box">
				<option value="Admin Department">Pending Documents</option>
                                <option value="Admin Department">Pending Finance</option>
                                <option value="Admin Department">Fees Related Queries</option>
                                <option value="Library Related">Book lost/Misplaced</option>
                                <option value="Library Related">Request Book</option>
				<option value="Academics">Class Room Problem</option>
                                <option value="Academics">Teacher UnAvailable</option>
                                <option value="Academics">Class Hours</option>
                                <option value="Academics">Outdated Lab Equipment</option>
