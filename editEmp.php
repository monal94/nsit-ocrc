...
<?php 
$eid = (int)$_GET['eId']; 
$sql= "SELECT * FROM tbl_employee WHERE eid = $eid";
$result = dbQuery($sql);
while($data = dbFetchAssoc($result)){
extract($data);
?>
<h3>Edit Employee Details - Admin View</h3>
<form action="process.php?action=editEmp" method="post"  name="frmListUser" id="frmListUser">
  <table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#336699" class="entryTable">
    <tr id="entryTableHeader">
      <td>:: Edit Employee Details ::</td>
    </tr>
    <tr>
