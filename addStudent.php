...
<form action="process.php?action=addStudent" method="post"  name="frmListUser" id="frmListUser">
      ...
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr class="entryTable">
             ...
             <td class="content"><input name="txtRoll" type="text" class="box" id="txtRoll" value="" size="30" maxlength="20" /></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;Branch. </td>
             <td class="content"><input name="txtbranch" type="text" class="box" id="txtbranch" value="" size="30" maxlength="20" /></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;Sem/Year </td>
             <td class="content"><input name="txtyear" type="text" class="box" id="txtyear" value="" size="30" maxlength="20" /></td>
           </tr>
           <tr class="entryTable">
